...
* Созадть все необходимые файлы для проекта(html, js, css, sqlite, папку с фотографиями)
...
* Определить какие данные будуд храниться в БД(данные о товаре, фотография, пароли, логины, какие товары в корзине) и решить какие товары будут на сайте
