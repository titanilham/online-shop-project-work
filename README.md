...
* Добавить хеширование или сделать регистрацию через другие аккаунты

### 4) Подключить базу данных:
* Определить какие данные будут храниться в БД(данные о товаре, фотография, пароли, логины, какие товары в корзине) и решить какие товары будут на сайте и как их добавлять(через админ панель или как то иначе)
